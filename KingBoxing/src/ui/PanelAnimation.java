...
public class PanelAnimation extends JPanel implements Runnable {
...
//	Thread thread2;
	...
	public PanelAnimation(GameFrame gameFrame) {
		...
		// thread.start();
//		thread1 = new Thread(gameFrame.music);
//		thread1.start();
	...
	public void paintComponent(Graphics g) {
		...
		g2.drawImage(gameFrame.images.animation.get(imageNumber), 0, 0,
